...
parser.add_argument('--n_train_samp', type=int, default=500)
parser.add_argument('--n_test_samp', type=int, default=1000)
parser.add_argument('--length', type=float, default=0.5)
parser.add_argument('--noise', type=float, default=0.02)
parser.add_argument('--amp_min', type=float, default=0.3)
